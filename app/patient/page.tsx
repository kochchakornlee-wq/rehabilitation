    ...
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-md w-300 mx-auto">
        {loading ? (
          ...
          <>
            <h2 className="text-xl text-blue-500 font-bold mb-4">
      ...
      <main className="p-6 flex flex-col gap-6">
        <div className="bg-white p-6 rounded-xl w-300 mx-auto">
          <div className="grid grid-cols-4 gap-4">
            <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-xl shadow-xs transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:border-blue-400 cursor-pointer overflow-hidden">
              ...
              <div className="p-6 text-center">
                <a href={`/patientForm1?hn=${encodeURIComponent(displayHN)}`}>
                  <span className="bg-blue-500 text-white px-4 py-1 rounded-full text-xl font-semibold block w-fit">
                    OPD
                  </span>
                  <p className="bg-white p-2"></p>
                  <h6 className="text-gray-400 text-sm text-justify">
                    OPD Assessment Physiotherapy Department
                  </h6>
                </a>
                <p className="bg-white p-2"></p>
                <a
                  href={`/patientForm1?hn=${encodeURIComponent(displayHN)}`}
                  className="inline-flex items-center text-white bg-blue-500 box-border rounded-xl border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
                >
                  Select
                  <svg
            ...
            <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-xl shadow-xs transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:border-blue-400 cursor-pointer overflow-hidden">
              ...
              <div className="p-6 text-center">
                <a href={`/IPDForm?hn=${encodeURIComponent(displayHN)}`}>
                  ...
                  <p className="bg-white p-2"></p>
                  <h6 className="text-gray-400 text-sm text-justify">
                    IPD Assessment Physiotherapy Department
                  </h6>
                </a>
                <p className="bg-white p-2"></p>
                <a
                  href={`/IPDForm?hn=${encodeURIComponent(displayHN)}`}
                  className="inline-flex items-center text-white bg-blue-500 box-border rounded-xl border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
                >
                  Select
                  <svg
            ...
            <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-xl shadow-xs transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:border-blue-400 cursor-pointer overflow-hidden">
              ...
              <div className="p-6 text-center">
                <a href={`/first_visit?hn=${encodeURIComponent(displayHN)}`}>
                  ...
                  <p className="bg-white p-2"></p>
                  <h6 className="text-gray-400 text-sm text-justify">
                    Patient and Family Education Record
                  </h6>
                </a>
                <p className="bg-white p-2"></p>
                <a
                  href={`/first_visit?hn=${encodeURIComponent(displayHN)}`}
                  className="inline-flex items-center text-white bg-blue-500 box-border rounded-xl border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
                >
                  Select
                  <svg
            ...
            <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-xl shadow-xs transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:border-blue-400 cursor-pointer overflow-hidden">
              ...
              <div className="p-6 text-center">
                <a href={`/discharge?hn=${encodeURIComponent(displayHN)}`}>
                  ...
                  <p className="bg-white p-2"></p>
                  <h6 className="text-gray-400 text-sm text-justify">
                    Discharge Summary Physiotherapy Department
                  </h6>
                </a>
                <p className="bg-white p-2"></p>
                <a
                  href={`/discharge?hn=${encodeURIComponent(displayHN)}`}
                  className="inline-flex items-center text-white bg-blue-500 box-border rounded-xl border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
                >
                  Select
                  <svg
          ...
          <a
            href="/otherform"
            className="mt-5 flex justify-end text-right text-sm text-gray-400 hover:text-blue-700 underline hover:underline transition-colors"
          >
            Other Forms
          </a>
        </div>
