  ...
  const EyeIcon = ({ show, toggle }: { show: boolean; toggle: () => void }) => (
    ...
    >
      {show ? (
        ...
        >
          <path
            d="M3 3l18 18M10.584 10.587a2 2 0 002.828 2.83M9.363 5.365A9.466 9.466 0 0112 5c4.478 0 8.268 2.943 9.543 7a9.453 9.453 0 01-2.756 4.244"
            strokeLinecap="round"
          />
        </svg>
      ) : (
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            <div style={{ position: "relative" }}>
              <input
                ...
                style={{
                  width: "100%",
                  border: `1px solid ${confirm && confirm !== password ? "#ef4444" : "#e5e7eb"}`,
                  borderRadius: "12px",
                  padding: "13px 44px 13px 16px",
                  fontSize: "15px",
                  outline: "none",
