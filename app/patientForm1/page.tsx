...
export default function PatientForm() {
  ...
  function buildAfterFormData() {
    return {
      ...
      pain_location: afterlocationpain,
      pain_assessment: afterpainAssesmentTool,
  ...
  useEffect(() => {
    const prefillFromLastVisit = async () => {
      ...
      const parsedUnd: string[] = (() => {
        try {
          if (!rawUnd) return [];
          if (Array.isArray(rawUnd)) return rawUnd;
          return JSON.parse(rawUnd);
        } catch {
          return [];
        }
      })();
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      <div className="bg-white rounded-2xl mx-auto w-300 p-4 shadow-md">
        ...
        {activeTab === "before" && (
          <div>
            <div className="text-medium text-red-500 p-2">
              Diagnosis
              <input
              ...
              <div className="flex gap-6 mt-10 ml-4 w-full pr-4">
                {vitalSigns.map((item) => (
                  <div key={item.key} className="flex flex-col gap-1">
                    <label className="text-medium text-red-500">
                      {item.label}
                    </label>
            ...
            <div className="flex gap-1 w-full pl-4">
              <div className="flex flex-col mt-10 w-full">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-medium text-red-500 mt-4">
                    Short term goal
                  </label>
                  <AutocompleteTextarea
                    value={shortgoal}
