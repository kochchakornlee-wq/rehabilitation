...
export default function AuthPage() {
  ...
  const [forgotStep, setForgotStep] = useState<"input" | "confirm" | "sent">(
    "input",
  );
  ...
  const EyeIcon = ({ show, toggle }: { show: boolean; toggle: () => void }) => (
    ...
    >
      {show ? (
        ...
        >
          <path
            d="M3 3l18 18M10.584 10.587a2 2 0 002.828 2.83M9.363 5.365A9.466 9.466 0 0112 5c4.478 0 8.268 2.943 9.543 7a9.453 9.453 0 01-2.756 4.244M9.878 9.88A3 3 0 0014.12 14.12"
            strokeLinecap="round"
          />
          <path
            d="M3 3s2.647 3.294 4.5 5.5M21 21s-2.647-3.294-4.5-5.5"
            strokeLinecap="round"
          />
        </svg>
      ) : (
  ...
  const inputWithEye: React.CSSProperties = {
    ...inputBase,
    paddingRight: "44px",
  };
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(135deg, rgba(37,99,235,0.55) 0%, rgba(0,0,0,0.4) 100%)",
          zIndex: 1,
        }}
      />
      ...
      >
        ...
        <div
          style={{
            ...
            transform:
              mode === "signup" ? "translateX(0)" : "translateX(-60px)",
            pointerEvents: mode === "signup" ? "auto" : "none",
          }}
        >
          <img
            src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExZzBvbDl2NHlkdTR1aHF1Y3hndHFxYXlxaWZyNWZ6MDJ0NmdmZTlmZSZlcD12MV9zdGlja2Vyc19zZWFyY2gmY3Q9cw/10IEUy0f5V3WLu/giphy.webp"
            alt=""
          ...
          >
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <EyeIcon
                  show={showSignupPass}
                  toggle={() => setShowSignupPass(!showSignupPass)}
                />
              </div>
            </div>
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <EyeIcon
                  ...
                  toggle={() => setShowSignupConfirm(!showSignupConfirm)}
                />
              </div>
            </div>
          </div>
          ...
          >
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: "15px",
                    fontWeight: 600,
                    cursor: !forgotUsername.trim() ? "not-allowed" : "pointer",
                    opacity: !forgotUsername.trim() ? 0.6 : 1,
                  }}
                >
                  ถัดไป
                </button>
            ...
            {forgotStep === "confirm" && (
              <div style={{ textAlign: "center" }}>
                ...
                >
                  ระบบจะส่งลิงก์รีเซ็ตรหัสผ่านไปที่อีเมลที่ลงทะเบียนไว้
                  <br />
            ...
            {forgotStep === "sent" && (
              <div style={{ textAlign: "center" }}>
                ...
                >
                  ระบบส่งลิงก์รีเซ็ตรหัสผ่านไปที่อีเมลที่ลงทะเบียนไว้แล้ว
                  <br />
