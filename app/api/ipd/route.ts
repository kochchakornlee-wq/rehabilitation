...
export async function POST(req: NextRequest) {
  ...
  await pool.query(
    ...
    [
      ...
      body.visit_time ?? null, body.doctor ?? null, body.room ?? null,
      body.transporation ?? null,
      body.vital_signs ? JSON.stringify(body.vital_signs) : null,
      body.chief ?? null, body.diagnosis ?? null, body.physio_precaution ?? null,
      body.underly ? JSON.stringify(body.underly) : null, body.pain_score ?? null, body.location ?? null,      
      body.pain_assesment ?? null, body.characteristic ? JSON.stringify(body.characteristic) : null,
      body.duration ?? null, body.frequence ?? null, body.fall_risk ?? null,
      body.fall_risk_items ? JSON.stringify(body.fall_risk_items) : null,
      body.precaution ?? null, body.barthel ?? null, body.physical_exam ?? null,
      ...
      body.suggest ?? null, body.status ?? null, body.therapist ?? null,
...
export async function PUT(req: NextRequest) {
  ...
  await pool.query(
    `UPDATE ipd_forms SET
     ...
     treatment_items=?, treatment_detail=?, suggest=?, status=?, therapist=?,
     assesment=?
     WHERE id=?`,
    [
      body.type ?? null, body.visit_date ?? null, body.visit_time ?? null,
      body.doctor ?? null, body.room ?? null, body.transporation ?? null,
      body.vital_signs ? JSON.stringify(body.vital_signs) : null,
      body.chief ?? null, body.diagnosis ?? null, body.physio_precaution ?? null,
      body.underly ?? null, body.pain_score ?? null, body.location ?? null,
      body.pain_assesment ?? null, body.characteristic ?? null,
      body.duration ?? null, body.frequence ?? null, body.fall_risk ?? null,
      body.fall_risk_items ? JSON.stringify(body.fall_risk_items) : null,
      body.precaution ?? null, body.barthel ?? null, body.physical_exam ?? null,
      body.treatmentplan ?? null, body.short_goal ?? null, body.long_goal ?? null,
