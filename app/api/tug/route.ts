...
export async function POST(req: NextRequest) {
  ...
  await pool.query(
    ...
    [
      id,
      body.patient_hn ?? null, body.patient_name ?? null,
      body.assessment_date ?? null, body.assessment_time ?? null,
      body.assessment_type ?? null, body.physiotherapist ?? null,
      body.walking_ability ?? null, body.time_to_complete ?? null,
      body.safety_classification ?? null, body.assistive_device ?? null,
      body.return_direction ?? null, body.visual_aids ?? null,
    ]
  )
...
export async function PUT(req: NextRequest) {
  ...
  await pool.query(
    `UPDATE tug_assessments SET
     ...
     WHERE id=?`,
    [
      body.patient_name ?? null, body.assessment_date ?? null,
      body.assessment_time ?? null, body.assessment_type ?? null,
      body.physiotherapist ?? null, body.walking_ability ?? null,
      body.time_to_complete ?? null, body.safety_classification ?? null,
      body.assistive_device ?? null, body.return_direction ?? null,
