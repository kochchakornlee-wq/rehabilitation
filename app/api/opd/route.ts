  ...
  await pool.query(
    `INSERT INTO opd_forms
     (id, hn, type, visit_date, visit_time, doctor, diagnosis, pain_score,
      visit_number, vn, Transporation, Physio_precaution, underly, location,
    ...
    [
      id,
      body.hn ?? null, body.type ?? null, body.visit_date ?? null,
      body.visit_time ?? null, body.doctor ?? null, body.diagnosis ?? null,
      body.pain_score ?? null, body.visit_number ?? null, body.vn ?? null,
      body.Transporation ?? null, body.Physio_precaution ?? null,
      body.underly ? JSON.stringify(body.underly) : null, body.location ?? null, body.pain_assesment ?? null,
      body.characteristic ? JSON.stringify(body.characteristic) : null, body.Duration ?? null, body.frequence ?? null,
      body.barthel ?? null, body.physical_exam ?? null, body.treatmentPlan ?? null,
      body.short_goal ?? null, body.long_goal ?? null,
      body.assesment ? JSON.stringify(body.assesment) : null,
      body.fall_risk ?? null,
      body.fall_risk_items ? JSON.stringify(body.fall_risk_items) : null,
      body.vital_signs ? JSON.stringify(body.vital_signs) : null, body.chief ?? null, body.therapist ?? null,
      body.suggest ?? null, body.status ?? null,
...
export async function PUT(req: NextRequest) {
  ...
  await pool.query(
    `UPDATE opd_forms SET
     ...
     visit_number=?, vn=?, Transporation=?, Physio_precaution=?, underly=?,
     ...
     WHERE id=?`,
    [
      body.type ?? null, body.visit_date ?? null, body.visit_time ?? null,
      body.doctor ?? null, body.diagnosis ?? null, body.pain_score ?? null,
      body.visit_number ?? null, body.vn ?? null, body.Transporation ?? null,
      body.Physio_precaution ?? null, body.underly ?? null, body.location ?? null,
      body.pain_assesment ?? null, body.characteristic ?? null, body.Duration ?? null,
      body.frequence ?? null, body.barthel ?? null, body.physical_exam ?? null,
      body.treatmentPlan ?? null, body.short_goal ?? null, body.long_goal ?? null,
      body.assesment ? JSON.stringify(body.assesment) : null,
      body.fall_risk ?? null,
      body.fall_risk_items ? JSON.stringify(body.fall_risk_items) : null,
      body.vital_signs ?? null, body.chief ?? null, body.therapist ?? null,
      body.suggest ?? null, body.status ?? null,
      body.treatment_items ? JSON.stringify(body.treatment_items) : null,
      body.treatment_detail ? JSON.stringify(body.treatment_detail) : null,
      id,
