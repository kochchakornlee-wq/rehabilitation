...
export async function POST(req: NextRequest) {
  ...
  await pool.query(
    ...
    [
      id,
      body.hn ?? null, body.date ?? null, body.time ?? null,
      body.doctor ?? null, body.short_goal ?? null, body.long_goal ?? null,
      body.plan ?? null, body.intime ?? null, body.cause ?? null,
      body.pass ?? null,
      body.estimate ? JSON.stringify(body.estimate) : null,
      body.form_type ?? null, body.assessor ?? null, body.form_id ?? null,
    ]
  )
...
export async function PUT(req: NextRequest) {
  ...
  await pool.query(
    `UPDATE \`Discharge\` SET
     ...
     WHERE id=?`,
    [
      body.date ?? null, body.time ?? null, body.doctor ?? null,
      body.short_goal ?? null, body.long_goal ?? null, body.plan ?? null,
      body.intime ?? null, body.cause ?? null, body.pass ?? null,
      body.estimate ? JSON.stringify(body.estimate) : null,
      body.form_type ?? null, body.assessor ?? null, body.form_id ?? null,
      id,
    ]
